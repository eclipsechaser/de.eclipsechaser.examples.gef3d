 ...
 * $Id$
 */
package de.eclipsechaser.examples.gef3d.model.graph.impl;

import de.eclipsechaser.examples.gef3d.model.graph.AbstractNamedObject;
import de.eclipsechaser.examples.gef3d.model.graph.Edge;
import de.eclipsechaser.examples.gef3d.model.graph.Graph;
import de.eclipsechaser.examples.gef3d.model.graph.GraphFactory;
import de.eclipsechaser.examples.gef3d.model.graph.GraphPackage;
import de.eclipsechaser.examples.gef3d.model.graph.Node;
...
public class GraphPackageImpl extends EPackageImpl implements GraphPackage {
	 ...
	 * @generated
	 */
	private EClass abstractNamedObjectEClass = null;
	 ...
	 * @see de.eclipsechaser.examples.gef3d.model.graph.GraphPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getAbstractNamedObject() {
		return abstractNamedObjectEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getAbstractNamedObject_Name() {
		return (EAttribute)abstractNamedObjectEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		abstractNamedObjectEClass = createEClass(ABSTRACT_NAMED_OBJECT);
		createEAttribute(abstractNamedObjectEClass, ABSTRACT_NAMED_OBJECT__NAME);
	}
	...
	public void initializePackageContents() {
		...
		graphEClass.getESuperTypes().add(this.getAbstractNamedObject());
		nodeEClass.getESuperTypes().add(this.getAbstractNamedObject());
		...
		initEClass(abstractNamedObjectEClass, AbstractNamedObject.class, "AbstractNamedObject", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAbstractNamedObject_Name(), ecorePackage.getEString(), "name", "Some Name", 0, 1, AbstractNamedObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
